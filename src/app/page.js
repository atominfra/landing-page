          ...
          <div className="bg-gray-900 p-4 md:p-6 rounded-lg h-auto transition-all">
            <div className="flex flex-col md:flex-row  items-center justify-evenly ">
              ...
              <div className="flex flex-col justify-center text-center md:text-left md:w-[35vw]">
                ...
                <p className="text-white mb-6">
                  Seamless AI development, deployment and monitoring
                  <br />
                  in Cloud all through one interface!
                </p>
                <a
                  href={`${process.env.NEXT_AICLOUDLAB_URL}`}
                  target="_blank"
                ...
                >
                  <button className=" bg-[#009ded]  text-white px-4 py-2 w-[150px] rounded-full hover:bg-[#3591c0] transition-colors flex justify-center items-center ">
                    <div className="flex gap-1 font-bold">
                      Visit{' '}
                      <GoLinkExternal className=" font-bold stroke-2 mt-1" />
                    </div>
                  </button>
                </a>
              </div>
            </div>
            <div className="text-center w-full font-poppins text-3xl font-semibold my-20">
              We make AI deployment{' '}
              <span className="italic bg-gradient-to-r from-[#1AB7FF] to-[#0051FF] bg-clip-text text-transparent">
                super-fast
              </span>{' '}
              and affordable!
            </div>
            <div className="flex flex-wrap justify-center">
              {data.aicloudlab_features.map((box, index) => (
                <div
                  key={index}
                  className="w-full  md:w-[40%]  border-2 rounded-[10px] p-8 font-poppins bg-gray-800 m-4 md:min-h-[200px]"
                >
