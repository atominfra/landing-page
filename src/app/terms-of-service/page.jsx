    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-gray-800">
      <main className="flex-1 container mx-auto px-4 py-8 md:py-12 lg:py-16">
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p>For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean AMBITION FORGE PRIVATE LIMITED, whose registered/operational office is 235 Binnamangala, 13th Cross Road, 2nd Stage, Indiranagar Bengaluru KARNATAKA 560038 . "you", "your", "user", "visitor" shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.</p>
