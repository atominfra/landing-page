...
const FeedBack = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      toast.error('Please fill the form', { position: 'bottom-right' })
      return
    }
    try {
      setIsLoading(true)
  ...
  return (
    <div className='mb-12'>
      <div className="flex flex-col md:flex-row items-center justify-evenly p-8 bg-[#FFFFFF] max-w-7xl">
        ...
        >
          <h2 className="text-[1.72rem] text-black font-semibold my-5 lg:mt-0 text-center md:text-left">Contact Us</h2>
          ...
          <button
            type="submit"
            className="w-full bg-[#009ded] hover:bg-[#3591c0] text-white font-semibold py-3 rounded-[10px] transition-colors flex justify-center items-center"
          >
            {isLoading === true ? (
